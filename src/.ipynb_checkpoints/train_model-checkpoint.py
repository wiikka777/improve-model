...
from utils.summary_dat import cal_comments_dims, make_feature_with_comments, cal_field_dims, make_comment_weights_feature
...
class Learner(object):
    ...
    def _wrap_dat(self):
        # 提取显式评论权重
        train_weights = make_comment_weights_feature(self.train_dat, self.dat_name)
        vali_weights = make_comment_weights_feature(self.vali_dat, self.dat_name)
        test_weights = make_comment_weights_feature(self.test_dat, self.dat_name)
