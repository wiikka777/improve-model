...
def config_param_parser():
    ...
    # Paths for precomputed embeddings (allow switching between models)
    parser.add_argument('--photo_embeddings_path', type=str, default='/user/zhuohang.yu/u24922/csp/rec_datasets/KuaiComt/bert-embeddings.pt')
    parser.add_argument('--comment_embeddings_path', type=str, default='/user/zhuohang.yu/u24922/csp/rec_datasets/KuaiComt/bert-embeddings_comments.pt')
    return parser
